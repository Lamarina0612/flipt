...
func (ss *Snapshot) GetRule(ctx context.Context, p storage.NamespacePredicate, id string) (rule *flipt.Rule, _ error) {
...
func (ss *Snapshot) ListRules(ctx context.Context, req *storage.ListRequest[storage.ResourcePredicate]) (set storage.ResultSet[*flipt.Rule], _ error) {
...
func (ss *Snapshot) CountRules(ctx context.Context, req storage.ResourcePredicate) (uint64, error) {
...
func (ss *Snapshot) GetSegment(ctx context.Context, req storage.ResourcePredicate) (*flipt.Segment, error) {
	ns, err := ss.getNamespace(req.Namespace())
	if err != nil {
		return nil, err
	}
...
func (ss *Snapshot) ListSegments(ctx context.Context, req *storage.ListRequest[storage.NamespacePredicate]) (set storage.ResultSet[*flipt.Segment], err error) {
	ns, err := ss.getNamespace(req.Predicate.Namespace())
	if err != nil {
		return set, err
	}
...
func (ss *Snapshot) CountSegments(ctx context.Context, p storage.NamespacePredicate) (uint64, error) {
	ns, err := ss.getNamespace(p.Namespace())
	if err != nil {
		return 0, err
	}
...
func (ss *Snapshot) GetNamespace(ctx context.Context, p storage.NamespacePredicate) (*flipt.Namespace, error) {
	ns, err := ss.getNamespace(p.Namespace())
	if err != nil {
		return nil, err
	}
...
func (ss *Snapshot) ListNamespaces(ctx context.Context, req *storage.ListRequest[storage.ReferencePredicate]) (set storage.ResultSet[*flipt.Namespace], err error) {
...
func (ss *Snapshot) CountNamespaces(ctx context.Context, _ storage.ReferencePredicate) (uint64, error) {
	return uint64(len(ss.ns)), nil
}

func (ss *Snapshot) GetFlag(ctx context.Context, req storage.ResourcePredicate) (*flipt.Flag, error) {
	ns, err := ss.getNamespace(req.Namespace())
	if err != nil {
		return nil, err
	}
...
func (ss *Snapshot) ListFlags(ctx context.Context, req *storage.ListRequest[storage.NamespacePredicate]) (set storage.ResultSet[*flipt.Flag], err error) {
	ns, err := ss.getNamespace(req.Predicate.Namespace())
	if err != nil {
		return set, err
	}
...
func (ss *Snapshot) CountFlags(ctx context.Context, p storage.NamespacePredicate) (uint64, error) {
	ns, err := ss.getNamespace(p.Namespace())
	if err != nil {
		return 0, err
	}
...
func (ss *Snapshot) GetEvaluationRules(ctx context.Context, flag storage.ResourcePredicate) ([]*storage.EvaluationRule, error) {
	ns, ok := ss.ns[flag.Namespace()]
	if !ok {
		return nil, errs.ErrNotFoundf("namespace %q", flag.NamespacePredicate)
	}
...
func (ss *Snapshot) GetEvaluationDistributions(ctx context.Context, rule storage.IDPredicate) ([]*storage.EvaluationDistribution, error) {
...
func (ss *Snapshot) GetEvaluationRollouts(ctx context.Context, flag storage.ResourcePredicate) ([]*storage.EvaluationRollout, error) {
	ns, ok := ss.ns[flag.Namespace()]
	if !ok {
		return nil, errs.ErrNotFoundf("namespace %q", flag.NamespacePredicate)
	}
...
func (ss *Snapshot) GetRollout(ctx context.Context, p storage.NamespacePredicate, id string) (*flipt.Rollout, error) {
	ns, err := ss.getNamespace(p.Namespace())
	if err != nil {
		return nil, err
	}
...
func (ss *Snapshot) ListRollouts(ctx context.Context, req *storage.ListRequest[storage.ResourcePredicate]) (set storage.ResultSet[*flipt.Rollout], err error) {
	ns, err := ss.getNamespace(req.Predicate.Namespace())
	if err != nil {
		return set, err
	}
...
func (ss *Snapshot) CountRollouts(ctx context.Context, flag storage.ResourcePredicate) (uint64, error) {
