...
func TestListFlags(t *testing.T) {
	...
	listByDefault := storage.NewListRequest[storage.NamespacePredicate](ns)
...
func TestListRules(t *testing.T) {
	...
	listByDefault := storage.NewListRequest(
...
func TestCountNamespaces(t *testing.T) {
	...
	ref := storage.ReferencePredicate{}
