...
func TestAuthentication_ListAuthentications_ByMethod(t *testing.T) {
	...
	t.Run("method == none", func(t *testing.T) {
		...
		req := storage.NewListRequest(storageauth.ListMethod(rpcauth.Method_METHOD_NONE))
	...
	t.Run("method == token", func(t *testing.T) {
		...
		req := storage.NewListRequest(storageauth.ListMethod(rpcauth.Method_METHOD_TOKEN))
