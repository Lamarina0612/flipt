...
func (s *DBTestSuite) TestListRollouts() {
	...
	res, err := s.store.ListRollouts(context.TODO(), storage.NewListRequest(storage.NewResource(storage.DefaultNamespace, flag.Key)))
	require.NoError(t, err)
...
func (s *DBTestSuite) TestListRolloutsNamespace() {
	...
	res, err := s.store.ListRollouts(context.TODO(), storage.NewListRequest(storage.NewResource(s.namespace, flag.Key)))
	require.NoError(t, err)
...
func (s *DBTestSuite) TestListRolloutsPagination_LimitOffset() {
	...
	res, err := s.store.ListRollouts(context.TODO(), storage.NewListRequest(
