...
func (s *Store) GetRollout(ctx context.Context, ns storage.NamespacePredicate, id string) (*flipt.Rollout, error) {
	return getRollout(ctx, s.builder, ns, id)
}

func getRollout(ctx context.Context, builder sq.StatementBuilderType, ns storage.NamespacePredicate, id string) (*flipt.Rollout, error) {
	var (
...
func (s *Store) ListRollouts(ctx context.Context, req *storage.ListRequest[storage.ResourcePredicate]) (storage.ResultSet[*flipt.Rollout], error) {
	var (
...
func (s *Store) CountRollouts(ctx context.Context, flag storage.ResourcePredicate) (uint64, error) {
	var count uint64
