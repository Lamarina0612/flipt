...
func (s *Store) GetFlag(ctx context.Context, p storage.ResourcePredicate) (*flipt.Flag, error) {
	var (
...
func (s *Store) ListFlags(ctx context.Context, req *storage.ListRequest[storage.NamespacePredicate]) (storage.ResultSet[*flipt.Flag], error) {
	var (
		flags   []*flipt.Flag
...
func (s *Store) CountFlags(ctx context.Context, p storage.NamespacePredicate) (uint64, error) {
	var count uint64
