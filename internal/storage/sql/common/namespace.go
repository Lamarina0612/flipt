...
func (s *Store) GetNamespace(ctx context.Context, p storage.NamespacePredicate) (*flipt.Namespace, error) {
	var (
...
func (s *Store) ListNamespaces(ctx context.Context, req *storage.ListRequest[storage.ReferencePredicate]) (storage.ResultSet[*flipt.Namespace], error) {
	var (
...
func (s *Store) CountNamespaces(ctx context.Context, _ storage.ReferencePredicate) (uint64, error) {
	var count uint64
