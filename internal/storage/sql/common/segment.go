...
func (s *Store) GetSegment(ctx context.Context, req storage.ResourcePredicate) (*flipt.Segment, error) {
	var (
...
func (s *Store) ListSegments(ctx context.Context, req *storage.ListRequest[storage.NamespacePredicate]) (storage.ResultSet[*flipt.Segment], error) {
	var (
...
func (s *Store) CountSegments(ctx context.Context, ns storage.NamespacePredicate) (uint64, error) {
	var count uint64
