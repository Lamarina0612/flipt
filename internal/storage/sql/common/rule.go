...
func (s *Store) GetRule(ctx context.Context, ns storage.NamespacePredicate, id string) (*flipt.Rule, error) {
	var (
...
func (s *Store) ListRules(ctx context.Context, req *storage.ListRequest[storage.ResourcePredicate]) (storage.ResultSet[*flipt.Rule], error) {
	var (
		rules   []*flipt.Rule
...
func (s *Store) CountRules(ctx context.Context, flag storage.ResourcePredicate) (uint64, error) {
	var count uint64
