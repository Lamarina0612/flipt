...
func (s *Store) GetEvaluationRules(ctx context.Context, flag storage.ResourcePredicate) (_ []*storage.EvaluationRule, err error) {
...
func (s *Store) GetEvaluationDistributions(ctx context.Context, rule storage.IDPredicate) (_ []*storage.EvaluationDistribution, err error) {
...
func (s *Store) GetEvaluationRollouts(ctx context.Context, flag storage.ResourcePredicate) (_ []*storage.EvaluationRollout, err error) {
	rows, err := s.builder.Select(`
		r.id,
		r.namespace_key,
		r."type",
